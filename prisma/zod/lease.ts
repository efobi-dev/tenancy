...
import { CompleteUnit, relatedUnitModel, CompleteTenant, relatedTenantModel, CompletePayment, relatedPaymentModel, CompleteDocument, relatedDocumentModel, CompleteImage, relatedImageModel } from "./index"
 ...
 */
export const relatedLeaseModel: z.ZodSchema<CompleteLease> = z.lazy(() => leaseModel.extend({
